...
contract LiquidationOperator is IUniswapV2Callee {
    ...
    constructor() {
        ...
        //debt_USDT = 2000*1000000;
        //debt_USDT = 5000*1000000;
        //debt_USDT = 10000*1000000;
        //debt_USDT = 10000*1000000;
        debt_USDC = 8128.956343*1000000;

        // เพราะ USDT token has 6 decimals
    ...
    function uniswapV2Call(
        ...
        console.log("reserve WETH: %s", reserve_WETH_Pool1);
        console.log("reserve USDC: %s", reserve_USDC_Pool1);

        //console.log("uniswapV2Pair(%s): WETH <> WETH", address(uniswapV2Pair_WETH_WETH));
        //console.log("reserve WETH: %s", reserve_WETH_Pool2);
        //console.log("reserve WETH: %s", reserve_WETH_Pool2);

        // 2.1 liquidate the target user
        
        console.log("--------liquidate the target user--------");
    
        uint debtToCover = amount1; // USDC ที่นำไป liquidate
        ...
        console.log("Repay_WETH: ", repay_WETH ); // WETH ที่ต้องจ่ายคืน
